...
> Cart-UseReducer-React is a project developed using ReactJS and styled with TailwindCSS. The primary goal of this project is to enhance my understanding of the reducer hook. This is the reason behind the creation of this project. For a deeper understanding, feel free to download or check out the live demo.
